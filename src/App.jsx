...
function hasTurnstileSitekey() {
  ...
  return Boolean(import.meta.env?.VITE_TURNSTILE_SITEKEY);
}
...
export default function App() {
  ...
  const [turnstileReady] = useState(() => hasTurnstileSitekey());
    ...
    CC BY-NC
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
        ...
        <Tip
          text={
            turnstileReady
              ? "Start the measurements (IPv4 and IPv6 side by side)."
              : 'Run is disabled because Turnstile is not configured (missing VITE_TURNSTILE_SITEKEY).'
          }
        >
          <button
            type="button"
            ...
            disabled={running || !turnstileReady}
