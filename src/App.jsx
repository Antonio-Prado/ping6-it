    ...
    CC BY-NC
      ...
      <div style={{ display: "grid", gap: 10, marginBottom: 12 }}>
        ...
        <div style={{ fontSize: 12, opacity: 0.75 }}>
          Nota: alcuni preset avanzati disattivano “IPv6-capable only” per ampliare la copertura. Il confronto v4/v6 resta
          attivo, ma richiede comunque probe IPv6 disponibili; in caso contrario Globalping può restituire “no probes found”.
        </div>
      </div>
      </>
      )}
